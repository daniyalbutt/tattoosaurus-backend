        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="discount-img">
                    <img src="https://samplelinkweb.site/custom-html/tattoosaurus-front/user/img/discount-placeholder.png" alt="">
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="custom-tattoo-design">
                                        <a href="javascript:;" class="ms-toggler" data-target="#ms-recent-activity" data-toggle="slideRight">
                                            <h4>Custom Tattoo Design</h4>
                                            <p>Approved</p>
                                            <div class="user-img">
